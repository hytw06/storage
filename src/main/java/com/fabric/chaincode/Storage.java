...
public class Storage extends ChaincodeBase {

    private static Log _logger = LogFactory.getLog(Storage.class);

    @Override
    public Response init(ChaincodeStub stub) {
        _logger.info("Init chaincode storage.");
    ...
    public Response invoke(ChaincodeStub stub) {
        try {
            _logger.info("Invoke chaincode storage.");
